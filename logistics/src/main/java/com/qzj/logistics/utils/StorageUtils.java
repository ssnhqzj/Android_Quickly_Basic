...
public final class StorageUtils {
	...
	private static final String INDIVIDUAL_DIR_NAME = "wjh_cache";
	...
	/**
	 * Returns individual application cache directory (for only data caching from WJH). Cache directory will be
	 * created on SD card <i>("/Android/data/[app_package_name]/cache/wjh_cache")</i> if card is mounted and app has
	 ...
	 *
	 * @param context Application context
	 * @param cacheDir Cache directory path (e.g.: "AppCacheDir", "AppDir/cache/datas")
	 * @return Cache {@link File directory}
	 */
	 ...
	 * @return
	 */
	public static File getImageUpDir(Context context){
			return getIndividualCacheDirectory(context,"dataUp");
	}
