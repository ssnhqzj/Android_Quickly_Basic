...
public class TDevice {
    ...
    public static int getDefaultLoadFactor() {
        if (_loadFactor == null) {
            Integer integer = Integer.valueOf(0xf & MyApplication.mContext
    ...
    public static DisplayMetrics getDisplayMetrics() {
        ...
        ((WindowManager) MyApplication.mContext.getSystemService(
    ...
    public static boolean hasBigScreen() {
        ...
        if (_hasBigScreen == null) {
            boolean flag1;
            if ((0xf & MyApplication.mContext.getResources()
    ...
    public static final boolean hasCamera() {
        if (_hasCamera == null) {
            PackageManager pckMgr = MyApplication.mContext
                    .getPackageManager();
            boolean flag = pckMgr
    ...
    public static boolean isPackageExist(String pckName) {
        try {
            PackageInfo pckInfo = MyApplication.mContext.getPackageManager()
    ...
    public static void hideSoftKeyboard(View view) {
        if (view == null)
            return;
        ((InputMethodManager) MyApplication.mContext.getSystemService(
    ...
    public static boolean isLandscape() {
        boolean flag;
        if (MyApplication.mContext.getResources().getConfiguration().orientation == 2)
            flag = true;
        else
            flag = false;
        return flag;
    ...
    public static boolean isPortrait() {
        boolean flag = true;
        if (MyApplication.mContext.getResources().getConfiguration().orientation != 1)
            flag = false;
        return flag;
    }
    ...
    public static String getCurCountryLan() {
        return MyApplication.mContext.getResources().getConfiguration().locale
                .getLanguage()
                + "-"
                + MyApplication.mContext.getResources().getConfiguration().locale
                .getCountry();
    }

    public static boolean isZhCN() {
        String lang = MyApplication.mContext.getResources()
    ...
    public static int getVersionCode() {
        ...
        try {
            versionCode = MyApplication
                    .mContext
                    .getPackageManager()
                    .getPackageInfo(MyApplication.mContext.getPackageName(),
                            0).versionCode;
    ...
    public static int getVersionCode(String packageName) {
        int versionCode = 0;
        try {
            versionCode = MyApplication.mContext.getPackageManager()
    ...
    public static boolean isScreenOn() {
        PowerManager pm = (PowerManager) MyApplication.mContext
    ...
    public static String getIMEI() {
        TelephonyManager tel = (TelephonyManager) MyApplication.mContext
    ...
    public static void openApp(Context context, String packageName) {
        Intent mainIntent = MyApplication.mContext.getPackageManager()
    ...
    public static void copyTextToBoard(String string) {
        if (TextUtils.isEmpty(string))
            return;
        ClipboardManager clip = (ClipboardManager) MyApplication.mContext
    ...
    public static int getStatuBarHeight() {
        ...
        try {
            ...
            field = c.getField("status_bar_height");
            x = Integer.parseInt(field.get(obj).toString());
            sbar = MyApplication.mContext.getResources()
                    .getDimensionPixelSize(x);
