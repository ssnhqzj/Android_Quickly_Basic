...
public class DownloadTask extends Object {
    public String STORE_PATH = "/mnt/sdcard/";
    ...
    public void start(Context context, DownloadListener listener,boolean isOnlyGetHead) {
    ...
    public void setSTORE_PATH(String appendPath){
        STORE_PATH += appendPath + "/";
    }
}
